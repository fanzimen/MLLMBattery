...
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True  # ✅ 减少碎片
...
torchrun --nnodes=1 --nproc_per_node=4 --master_port=29501 src/open_clip_train/main.py \
    ...
    --name "battery_tllm_btr2048_qwen2.5_${NOW}" \
    --report-to wandb \
    --accum-freq 1 \
    --warmup 1000 \
    --grad-clip-norm 1.0 \
    ...
    --lock-text \
        ...
        # --model btr-1024-qwen2.5 \    --name "battery_qwen_1024_${NOW}" \